# GDG PUP React.js Study Jam (SJ3 Boilerplate)

Welcome to the React.js Study Jam. React is an open-source JavaScript library from Meta for building dynamic and interactive user interfaces, from simple portfolios to complex web apps.
